    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Tasks</h3>
                <p class="text-subtitle text-muted">Manage data tugas</p>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('tasks.store') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary">Create Tugas</button>
                    <a href="{{ route('tasks.index') }}" class="btn btn-secondary">Kembali Ke Tugas</a>
                </form>
            </div>
        </div>
    </section>

    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Tugas</h3>
                <p class="text-subtitle text-muted">Data Tugas</p>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('tasks.update', $task->id ) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control date @error('due_date') is-invalid @enderror" value="{{ @old('due_date', $task->due_date)}}" name="due_date" value="{{ old('due_date', $task->due_date) }}" required>
                        @error('due_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <a href="{{ route('tasks.index') }}" class="btn btn-secondary">Back to Tugas List</a>
                </form>
            </div>
        </div>
    </section>
